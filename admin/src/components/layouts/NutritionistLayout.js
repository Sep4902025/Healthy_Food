              ...
              <li>
                ...
                {isIngredientOpen && (
                  <ul className="ml-4 space-y-1 transition-all">
                    ...
                    <li>
                      <NavLink
                        to="/nutritionist/ingredients/add"
                        className="block p-2 hover:bg-gray-200"
                      >
                        Add New Ingredient
                      </NavLink>
