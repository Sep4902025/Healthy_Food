...
import { FaUser, FaEdit, FaShoppingCart, FaBan, FaKey, FaQuestionCircle, FaStar } from 'react-icons/fa';
    ...
    setReviews([
      {
        ...
        rating: 4,
        comment: 'excellent conversation with him... very knowledgeable personhappy to talk towith him'
      }
    ]);
  };
    ...
    <div className="profile-container">
      <div className="profile-sidebar">
        <div className="sidebar-header">
          <div className="profile-initial">{user.username ? user.username.charAt(0).toUpperCase() : 'G'}</div>
          <h2>My Profile</h2>
        </div>
        ...
        <div className="profile-main">
            ...
            <div className="profile-info-section">
              ...
              <div className="user-info">
                <div className="info-row">
                  <div className="info-label">Your Name</div>
                  <div className="info-value">{user.username || 'Sid'}</div>
                </div>
                <div className="info-row">
                  <div className="info-label">Email</div>
                  <div className="info-value">{user.email || 'siddxd@growthx.com'}</div>
                </div>
                <div className="info-row">
                  <div className="info-label">Phone Number</div>
                  <div className="info-value">{user.phone || '+91 9965284573'}</div>
                </div>
            ...
            <div className="profile-section body-measurements">
              ...
              <div className="measurements-grid">
                <div className="measurement-item">
                  ...
                  <div className="measurement-value">{user.weight || '80'} Kg</div>
                </div>
                <div className="measurement-item">
                  <div className="measurement-label">Height</div>
                  <div className="measurement-value">{user.height || '1.75'} M</div>
                </div>
                <div className="measurement-item">
          ...
          <div className="profile-details-card">
            <div className="favorite-food-section">
              ...
              <p className="section-description">This are the professional details shown to users in the app.</p>
              ...
              <div className="experience-section">
                ...
                <div className="experience-badge">
                  <div className="experience-years">{getFoodExperienceYears()} Years</div>
              ...
              <div className="ratings-section">
                ...
                <div className="rating-summary">
                  <div className="rating-number">★ {getAverageRating()} Stars</div>
                  <div className="rating-text">from {getRatingCount()} customers</div>
                </div>
              </div>
