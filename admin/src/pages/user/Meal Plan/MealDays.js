        ...
        <div className="bg-white rounded-lg shadow-md p-6 max-w-4xl mx-auto">
            ...
            <div className="mb-6">
                <div className="flex items-center text-sm text-gray-500 mb-2">
                    ...
                    <span className="text-gray-800 font-medium">{mealPlanInfo?.name || "Chi tiết kế hoạch"}</span>
                </div>
                ...
                {mealPlanInfo && (
                    <div className="flex items-center mt-2 text-gray-600">
                        ...
                        {mealPlanInfo.description && (
                            <p className="text-sm ml-4">{mealPlanInfo.description}</p>
                        )}
                    </div>
                )}
            </div>
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <Link to={`/meal-plan/${mealPlanId}/add-meal-day`}>
                        ...
                        >
                            ...
                            <div className="p-4">
                                <div className="flex items-center mb-3">
                                    <svg className="h-4 w-4 text-gray-500 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                ...
                                <div className="flex justify-between items-center mt-4">
                                    <Link 
                                        to={`/meal-plan/${mealPlanId}/meal-day/${mealDay._id}/meal`}
