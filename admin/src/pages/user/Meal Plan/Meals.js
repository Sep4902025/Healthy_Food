...
const Meals = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Lấy danh sách meals
        console.log(`📤 Gửi yêu cầu lấy Meals với MealPlan ID: ${mealPlanId}, MealDay ID: ${mealDayId}`);
  ...
  const handleDeleteDish = async (mealId, dishId) => {
    try {
      ...
      const response = await mealPlanService.removeDishFromMeal(mealPlanId, mealDayId, mealId, dishId);
    ...
    <div className="bg-white rounded-lg shadow-md p-6 max-w-4xl mx-auto">
      ...
      {meals.length === 0 ? (
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 text-center">
          <svg className="h-12 w-12 mx-auto text-gray-400 mb-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <Link to={`/meal-plan/${mealPlanId}/mealDay/${mealDayId}/add-meal`}>
        ...
        <div className="space-y-6">
          {meals.map((meal) => (
            <div key={meal._id} className="bg-white border border-gray-200 rounded-lg overflow-hidden">
              {/* Tiêu đề bữa ăn */}
              <div className="bg-green-50 border-b border-gray-200 px-4 py-3 flex justify-between items-center">
                <div className="flex items-center">
                  <svg className="h-5 w-5 text-green-600 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="p-4">
                ...
                {/* Nút thêm món ăn */}
                <div className="mt-4">
                  <Link to={`/meal-plan/${mealPlanId}/mealDay/${mealDayId}/meal/${meal._id}/add-dish`}>
